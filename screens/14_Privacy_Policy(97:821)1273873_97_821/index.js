  ...
  render = () => (
    ...
    >
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_97_839}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_97_840}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_97_841}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_97_842}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_97_846}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_97_851}
      />
      <View style={styles.View_98_857}>
        <View style={styles.View_98_858} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/5fc9/6d3c/5df345deaf462347b28a41ca5a5fddf5"
          }}
          style={styles.ImageBackground_98_859}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_98_860}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_98_861}
        />
      </View>
      <View style={styles.View_98_862}>
        <Text style={styles.Text_98_862}>
          Up to 70% OFF health &amp; wellness products
        </Text>
      </View>
      <View style={styles.View_98_863}>
        <Text style={styles.Text_98_863}>
      ...
      <View style={styles.View_98_864}>
        <Text style={styles.Text_98_864}>Privacy policy</Text>
      </View>
    </ScrollView>
  )
}
