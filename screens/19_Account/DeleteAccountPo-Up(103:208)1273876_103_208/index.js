...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_103_209} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2fdc/1028/f1a4140dc8b904b3d59efb8a3b0790c4"
        }}
        style={styles.ImageBackground_103_215}
      />
      <View style={styles.View_103_216}>
        <View style={styles.View_103_217} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/4903/5b8d/8b494ed76c0b76253af621d9ae3d3539"
          }}
          style={styles.ImageBackground_103_218}
        />
        <View style={styles.View_103_219} />
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_103_220}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_103_221}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_103_222}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_103_223}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_103_227}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_103_232}
      />
      <View style={styles.View_103_233}>
        <View style={styles.View_103_234} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/5fc9/6d3c/5df345deaf462347b28a41ca5a5fddf5"
          }}
          style={styles.ImageBackground_103_235}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_103_236}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_103_237}
        />
      </View>
      <View style={styles.View_103_238}>
        <Text style={styles.Text_103_238}>
          Up to 70% OFF health &amp; wellness products
        </Text>
      </View>
      <View style={styles.View_103_239}>
        <Text style={styles.Text_103_239}>
      ...
      <View style={styles.View_103_240}>
        <Text style={styles.Text_103_240}>Terms and coditions</Text>
      </View>
      <View style={styles.View_103_241} />
      <View style={styles.View_103_242} />
      <View style={styles.View_103_243}>
        <Text style={styles.Text_103_243}>
          You will delete all data and user information - Are you sure?
        </Text>
      </View>
      <View style={styles.View_103_244} />
      <View style={styles.View_103_245}>
        <Text style={styles.Text_103_245}>Yes</Text>
      </View>
      <View style={styles.View_103_246}>
        <Text style={styles.Text_103_246}>Cancel</Text>
      </View>
    </ScrollView>
  )
}
